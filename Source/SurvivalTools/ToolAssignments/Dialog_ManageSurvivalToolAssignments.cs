...
namespace SurvivalTools
{
    public class Dialog_ManageSurvivalToolAssignments : Window
    {
        ...
        public override void DoWindowContents(Rect inRect)
        {
            ...
            Rect rect4 = new Rect(0f, TopAreaHeight, inRect.width, inRect.height - TopAreaHeight - Window.CloseButSize.y).ContractedBy(10f);
            ...
            int openMask = 16;
            ThingFilterUI.DoThingFilterConfigWindow(rect7, thingFilterState, filter, parentFilter, openMask);
            GUI.EndGroup();
        }
